...
-- ==============================================================================
-- 4. AUTOMATIC GHANAIAN CURRICULUM SEEDING TRIGGER
-- ==============================================================================
...
-- Create private storage bucket for payment screenshots if not exists
INSERT INTO storage.buckets (id, name, public)
VALUES ('payment-screenshots', 'payment-screenshots', false)
ON CONFLICT (id) DO NOTHING;

-- Storage policy: Users can upload payment screenshots to their school's folder
