// Complete PostgreSQL DDL Schema for SamleyEduSuite Ghana
// Used by the in-app Database Table Setup Assistant and download/copy helpers
...
-- 2. Create Enums
DO $$ BEGIN
  CREATE TYPE user_role AS ENUM ('admin', 'teacher', 'parent', 'super_admin');
...
-- Admin helper: insert a profile for another user (bypasses RLS)
