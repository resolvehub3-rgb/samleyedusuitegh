    ...
    <div className="fixed bottom-6 right-6 z-50">
      ...
      {isOpen && (
        <div className="mb-4 w-[320px] bg-white dark:bg-slate-800 rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-700 overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-300">
          {/* Header */}
          <div className="bg-orange-600 dark:bg-slate-700 px-5 py-4 flex items-center justify-between">
          ...
          {/* Chat Body */}
          <div className="bg-slate-100 dark:bg-slate-700 px-5 py-6">
          ...
          <div className="bg-white dark:bg-slate-800 px-4 py-3 border-t border-slate-100 dark:border-slate-700">
            <a
              ...
              className="flex items-center justify-center gap-2 w-full px-5 py-3 bg-orange-600 hover:bg-orange-700 dark:bg-orange-600 dark:hover:bg-orange-700 text-white text-sm font-bold rounded-full shadow-lg shadow-orange-600/30 hover:shadow-xl hover:shadow-orange-600/40 transition-all active:scale-[0.98]"
            >
      ...
      <div className="relative">
        ...
        {!isOpen && (
          <>
            ...
            <span className="absolute inset-0 rounded-full bg-orange-600 animate-pulse opacity-10 scale-125" />
          </>
        )}
        <button
          ...
          className={`relative w-14 h-14 rounded-full shadow-lg flex items-center justify-center transition-all duration-300 ${
            isOpen
              ...
              : 'bg-orange-600 hover:bg-orange-700 shadow-orange-600/40 hover:shadow-orange-600/60 hover:scale-110'
          }`}
        >
          {isOpen ? (
